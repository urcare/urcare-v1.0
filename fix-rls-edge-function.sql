-- Fix RLS policies to allow Edge Function inserts
-- This script updates the RLS policies to allow the Edge Function to insert records
...
-- Update RLS policies to allow Edge Function inserts
...
-- Create new policies that allow Edge Function inserts
-- For development, we'll allow inserts for the specific development user ID
...
-- Also update user_profiles policies
