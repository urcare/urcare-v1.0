...
// Test with official PhonePe UAT credentials
const PHONEPE_CONFIG = {
  merchantId: 'PHONEPEPGUAT', // Official UAT merchant ID
  apiKey: 'c817ffaf-8471-48b5-a7e2-a27e5b7efbd3', // Official UAT API key
  saltIndex: '1',
...
async function testPhonePeUAT() {
  try {
    console.log('🧪 Testing PhonePe UAT API...');
