-- Nutrition Tracking Database Schema
-- This schema supports food intake tracking and calorie management
...
-- Function to automatically update daily_nutrition when food_entries change
