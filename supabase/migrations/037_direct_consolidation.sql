-- Direct Database Consolidation - Skip Problematic Migration 013
-- This creates the essential unified tables without conflicts
...
CREATE OR REPLACE VIEW health_scores AS
SELECT 
    id,
    user_id,
