      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            {isProcessing ? (mode === 'signup' ? 'Signing up...' : 'Signing in...') : (mode === 'signup' ? 'Sign up using Apple' : 'Sign in with Apple')}
          </button>
          <button
          ...
          >
            ...
            {isProcessing ? (mode === 'signup' ? 'Signing up...' : 'Signing in...') : (mode === 'signup' ? 'Sign up using Google' : 'Sign in with Google')}
          </button>
          <button
