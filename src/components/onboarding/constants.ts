...
export const ONBOARDING_BUTTON_STYLES = {
  primary:
    "w-full bg-gray-900 hover:bg-gray-800 text-white py-4 px-8 rounded-3xl text-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl",
  secondary:
    "w-full max-w-sm bg-gray-900 hover:bg-gray-800 text-white py-4 px-8 rounded-3xl text-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl",
  ghost: "p-2 hover:bg-gray-100 rounded-2xl",
};
