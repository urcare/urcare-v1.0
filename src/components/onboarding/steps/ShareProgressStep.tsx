    ...
    <div className="flex justify-center">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Health Progress Sharing</h3>
          <p className="text-sm text-gray-600">Would you like to share your health progress with family?</p>
        </div>
