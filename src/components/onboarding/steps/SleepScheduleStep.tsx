  ...
  <div className="space-y-6">
    <div className="flex justify-center space-x-8">
      <div className="flex flex-col items-center">
        <label className="text-sm font-medium text-gray-600 mb-2">Wake Up Time</label>
        <WheelPicker
          options={getTimeOptions()}
          selectedValue={wakeUpTime}
          onValueChange={(value) => onChange('wakeUpTime', value)}
          width="w-24"
        />
      </div>
      
      <div className="flex flex-col items-center">
        <label className="text-sm font-medium text-gray-600 mb-2">Sleep Time</label>
        <WheelPicker
          options={getTimeOptions()}
          selectedValue={sleepTime}
          onValueChange={(value) => onChange('sleepTime', value)}
          width="w-24"
        />
      </div>
    </div>
