...
import { Smartphone, Watch, X } from "lucide-react";
            ...
            <div className="space-y-4">
              <div className="text-center mb-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  What type of wearable do you use?
                </h3>
                <p className="text-sm text-gray-600">
                  Add your devices (e.g., Apple Watch, Fitbit, Samsung Galaxy
                  Watch)
                </p>
              </div>
              ...
              <div className="flex space-x-2">
                <Input
                  ...
                  className="flex-1 p-4 rounded-2xl border-2 border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20"
                />
                <Button
                  onClick={addWearableType}
                  className="px-6 py-4 rounded-2xl bg-primary hover:bg-primary/90 text-white"
                >
                  Add
                </Button>
              </div>
