...
export const ONBOARDING_RESPONSIVE_CLASSES = {
  ...
  continueButton:
    "w-full bg-gray-900 hover:bg-gray-800 text-white py-3 px-8 rounded-3xl text-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl",

  // Input classes
  inputContainer: "w-full space-y-3",
  input:
    "w-full h-12 sm:h-14 text-base sm:text-lg px-4 rounded-2xl border-2 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-200",
  ...
  choiceButton:
    "w-full p-4 sm:p-5 rounded-3xl border-2 border-gray-200 bg-white text-left transition-all duration-200 hover:border-gray-300 hover:shadow-md",
  ...
  multiChoiceItem:
    "flex items-center p-3 sm:p-4 rounded-2xl border-2 border-gray-200 bg-white transition-all duration-200 hover:border-gray-300",
  multiChoiceItemSelected: "border-blue-500 bg-blue-50",
  multiChoiceCheckbox:
    "w-5 h-5 sm:w-6 sm:h-6 rounded border-2 border-gray-300 flex items-center justify-center transition-all duration-200",
  multiChoiceCheckboxSelected: "border-blue-500 bg-blue-500",
  multiChoiceText:
    "text-base sm:text-lg font-medium text-gray-900 ml-3 sm:ml-4",

  // Wheel picker classes
  wheelPickerContainer:
    "h-48 sm:h-56 overflow-hidden flex flex-col justify-center focus:outline-none rounded-xl",
  wheelPickerItem:
    "flex items-center justify-center cursor-pointer transition-all duration-300 ease-out px-1 sm:px-2",
  wheelPickerText:
    "select-none text-center leading-tight pointer-events-none whitespace-nowrap overflow-hidden text-ellipsis max-w-full",

  // Welcome step classes
  welcomeContainer: "text-center w-full",
  welcomeIcon:
    "w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6",
  welcomeTitle:
    "text-xl sm:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4 px-2",
  welcomeDescription:
    "text-gray-600 text-base sm:text-lg leading-relaxed mb-4 sm:mb-6 px-2",
  welcomeCard:
    "bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-4 sm:p-6 border border-blue-100 mx-2",
