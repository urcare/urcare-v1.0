      ...
      <div className="relative z-10 w-full max-w-md text-center">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">AI-Powered Healthcare</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl p-8 border border-gray-100 dark:border-slate-700 transition-colors duration-300">
          <div className="text-center space-y-6">
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400 mb-8 p-4 bg-gray-50 dark:bg-slate-700 rounded-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                ...
                className="border-gray-300 dark:border-gray-600 hover:border-blue-300 rounded-xl px-6 py-3 text-lg font-semibold transition-all duration-300 dark:bg-slate-700 dark:text-white"
              >
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600 dark:text-gray-400">
            Need help? <Link to="/login" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-semibold">Sign in</Link> to access your dashboard
          </p>
        </div>
      </div>
    </div>
