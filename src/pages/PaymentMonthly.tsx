            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2">
                  <button
                    onClick={() => {
                      window.open('mailto:sarthaks264@gmail.com?subject=UrCare Monthly Subscription Payment&body=Please send payment of ₹849 for UrCare Monthly Subscription. Include your UTR/Reference ID in the email.', '_blank');
                    }}
