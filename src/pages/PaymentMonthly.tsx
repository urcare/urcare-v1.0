...
export default function PaymentMonthly() {
  ...
  const handleRazorpay = () => {
    ...
    const razorpayLink = "https://razorpay.me/@urcare?amount=vy%2F7jJNxh9pvHsb2%2Bqs52w%3D%3D";
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
            ...
            <div className="text-center">
              <button
                onClick={() => window.open('upi://pay?pa=urcare@icici&pn=UrCare&am=849&tn=UrCare%20Monthly%20Subscription&cu=INR', '_blank')}
