...
const AuthPage = () => {
  ...
  const roles: UserRole[] = ['Patient', 'Doctor', 'Nurse', 'Admin', 'Pharmacy', 'Lab', 'Reception'];
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    await signUp(signupData.email, signupData.password, signupData.fullName, signupData.role as UserRole);
  };
