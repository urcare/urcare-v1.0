-- Clean up duplicate functions and ensure only correct versions exist
-- This script removes duplicate functions and keeps only the correct ones
...
-- 4. Verify functions are created correctly
SELECT 
    routine_name, 
    routine_type, 
