-- Safe fix for get_user_daily_activities function
-- This handles existing function and creates it properly
...
-- Test the function
SELECT 'get_user_daily_activities function is ready' as status;
