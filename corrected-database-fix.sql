-- CORRECTED DATABASE SETUP FOR URCARE
-- This script matches your actual table structure
-- Run this in your Supabase SQL Editor

-- 1. Drop existing tables and functions if they exist (to allow re-running the script)
...
-- 5. Create get_weekly_view function
...
-- 6. Insert default data for current user (replace with your actual user ID)
