-- =====================================================
-- Add Health Assessment Completion Field
-- =====================================================

-- Add health_assessment_completed field to onboarding_profiles table
ALTER TABLE onboarding_profiles 
ADD COLUMN IF NOT EXISTS health_assessment_completed BOOLEAN DEFAULT FALSE;

-- Drop existing function first
DROP FUNCTION IF EXISTS save_onboarding_data(UUID, JSONB);

-- Update the save_onboarding_data function to handle health_assessment_completed
...
-- Update the get_onboarding_data function to include health_assessment_completed
...
DO $$
BEGIN
    RAISE NOTICE '✅ Health Assessment Field Added Successfully!';
    RAISE NOTICE '📊 Added health_assessment_completed field to onboarding_profiles';
    RAISE NOTICE '🔧 Updated save_onboarding_data and get_onboarding_data functions';
    RAISE NOTICE '🎯 Health assessment completion tracking is now ready!';
END $$;
