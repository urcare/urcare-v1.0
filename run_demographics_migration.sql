-- Run this SQL in your Supabase SQL Editor to add demographics fields
-- This migration adds country, state, and district fields to both user_profiles and onboarding_profiles tables
